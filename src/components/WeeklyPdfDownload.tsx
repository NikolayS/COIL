...
export function WeeklyPdfDownload({ weekOf, ready }: { weekOf: string; ready: boolean }) {
  ...
  return (
    <div>
      ...
      >
        <Download size={16} />
        {!ready ? "Waiting for changes to save…" : busy ? "Preparing PDF…" : ios ? (file ? "Save PDF" : "Retry PDF") : "Download PDF"}
      </button>
